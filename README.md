...
![Creating Dr. James Carter](Creating_Dr__J__Carter_User.png)

**Complete User Roster — 6 users provisioned across roles**
![Complete Users](Complete_users_for_Riverview_Regional.png)
...
![Physician Group](Dr_J__Carter-Physician_group.png)
...
![Granting Policy](Granting_Policy.png)

**Require MFA for IT Admins — Sign-in risk conditions (High + Medium)**
![Sign-in Risk](Sign-in_Risk_for_A__Rivera.png)

**Location Condition scoped to Alex Rivera**
![Location Condition](Location_Condition_for_A__Rivera.png)

**Policy targeting Alex Rivera — Report-only, Users and Groups scoped**
![Policy for Rivera](Policy_for_A__Rivera2.png)
...
![Password Protection](Password_Protection_settings.png)
