...
**Step 4 — All Riverview users confirmed in portal**
...
**Step 5 — Dr. James Carter assigned to Physicians group**

![Dr James Carter Physician Group](images/Dr_J__Carter-Physician_group.png)

Group membership confirmed for Dr. James Carter in the Physicians group. Group-based access is the foundation for role-scoped app assignments in Day 3 and business-owner-driven access reviews in Day 4.

**Step 6 — Password protection settings reviewed**

![Password Protection Settings](images/Password_Protection_settings.png)

Password protection configuration reviewed as part of Day 1 baseline security assessment. Documenting existing controls before adding new ones is a governance best practice.

**Step 7 — Policy for A. Rivera reviewed**
...
Location-based conditional access condition documented for Alex Rivera.

**Step 10 — Sign-in risk review for A. Rivera**
